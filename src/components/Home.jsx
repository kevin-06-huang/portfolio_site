    ...
    <div className="intro">
      <div className="column left">
        ...
        <div className="bragging-point">
          ...
          <h2 className="description">I like to code!</h2>
        </div>
      </div>
      <div className="column right">
        <div className="bragging-point top">
          <div className="img lightning"></div>
          <h2 className="description">This site uses CircleCI & Netlify!</h2>
        </div>
        <div className="bragging-point bottom-right">
          <div className="img normalization"></div>
          <h2 className="description">I'm still working on Testing!</h2>
        </div>
      </div>
    </div>
  );
